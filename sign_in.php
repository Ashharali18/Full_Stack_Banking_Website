...
if(isset($_REQUEST['LogIn'])){
    ...
    $res=mysqli_query($conn,"select * from signup where Email='$username'");
    if(mysqli_num_rows($res)>0){
        ...
        if($verify==1){
            ...
            echo "<script>alert('Invalid password..!!!');window.location='/Project/sign_in.php/'</script>";
        }
    }
    else{
        echo "<script>alert('Invalid username..!!!');window.location='/Project/sign_in.php/'</script>";   
    }
...
<body>
    ...
    <div class="slidebar">
        ...
        <ul>
            <li><a href="../front_page.php/"><i class="fas fa-qrcode"></i>Dashboard</a></li>
    ...
    <form action="" method="post">
        ...
        <br>
        <input type="email" class="ainput" name="username" required placeholder="Email">
      
        <br>
        <input type="password" class="binput" name="password" required placeholder="Password">
