...
if(isset($_REQUEST['Enter'])){
    ...
    $res=mysqli_query($conn,"select * from signup where verification_code='$otp'");
    if(mysqli_num_rows($res)==1){
        echo "<script>alert('You have successfully sign up to ITU BANK LIMITED');window.location='../Project/Accounts.php/'</script>";
           
        }
        else{
            echo "<script>alert('Invalid otp..!!!');window.location='/Project/email_verification.php'</script>";
...
<body>
    ...
    <form action="" method="post">
        <p class="start">Welcome to ITU Digital Banking</p>
        <br>
        <label for=""class="d">Sign in or Join now to manage your personal finances</label>
        <br>
        <input type="text" class="ainput" name="otp" required placeholder="Enter your OTP">
        <br>
        <input class="button" type="submit" value="Enter" name="Enter">
        <hr>
        <label for=""class="hr">Download ITU Mobile</label>
