...
if(isset($_REQUEST['btn'])){
    ...
    if(mysqli_num_rows($res)==true){
        echo "<script>alert('You have successfully send money');window.location='../logged_in.php/'</script>";
            ...
            echo "<script>alert('Invalid otp..!!!');window.location='../donation_confrmation.php/'</script>";
            ...
            <form action="" method="post" class="decor">
                ...
                <div class="form-inner">
                    <h1>Send Money</h1>
                        ...
                        <input type="text" name="otp" placeholder="Enter the OTP sent to email">
                        <br>
                    </div>
                    <div class="f5"> <button type="submit" name="btn">Next</button></div>
