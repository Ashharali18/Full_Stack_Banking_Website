...
<div class="header"><header><img class="pic" src="pic.png" alt=""></header></div>
    ...
    <div class="form">
        <form action="" method="post">
            ...
            <div><p id="message">Password is <span id="strength"></span></p></div>
            <script>
        ...
        pass.addEventListener('input',() =>{
            ...
            <div><input class="CNIC" type="text" name="CNIC" onclick="numbersonly(this)" data-inputmask="'mask':'99999-9999999-9'" required placeholder="CNIC"></div>
            <script type="text/javascript">
                $(':input').inputmask();
            </script>
            <div><input class="phonenumber" type="text" name="phonenumber" required placeholder="Phone number"  onclick="numbersonly(this)"  data-inputmask="'mask':'+99-999-9999999'"></div>
            <script type="text/javascript">
                $(':input').inputmask();
            </script>
            <div>
    ...
    <select class="year" name="year" id="">
        ...
        <option value="2022">2022</option>
            ...
            <div>
                ...
                <br>
               <fieldset class="F"><label for="">Female</label><input class="f" type ="radio" name="gender" required value="Female" ></fieldset>
               <fieldset class="M"><label for="">Male</label> <input class="ma" type="radio"name="gender" required value="Male"></fieldset>
               <fieldset class="C"><label for="">Custom</label> <input class="c" type="radio"name="gender" required value="Custom"></fieldset>

            </div>
            <div><input class="button" type="submit" value="SignUp" name="signup"></div>
        </form>
    </div>
</body>
</html>